...
const CODE = `// About/Intro.tsx — Full-screen hero with teal gradient bg
<section className="relative min-h-screen flex items-center overflow-hidden">
  ...
  <div className="container-app relative z-10 py-24">
    <div className="max-w-2xl">
      ...
      <div style={{ width: 48, height: 2, background: '#4eaeba' }} />
      <p className="body-lg mt-6" style={{ color: 'rgba(255,255,255,0.75)' }}>
        Full-stack developer & creative director building things
        that matter — and look good doing it.
      </p>
